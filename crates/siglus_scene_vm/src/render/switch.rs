//! Native scene renderer of the Switch frontend.
//!
//! The desktop WGPU renderer stays in `render/mod.rs` and the PS Vita GXM
//! renderer in `render/vita`; the Switch frontend presents this module's
//! RGBA output through its own display API.
